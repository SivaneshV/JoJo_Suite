...
namespace JoJoSuite.Actions.Office.Excel.Design
{
    ...
    public partial class CreateWorkbookDesigner
    {
        public CreateWorkbookDesigner()
        {
            InitializeComponent();
        }
        public static void RegisterMetadata(AttributeTableBuilder builder)
        {
            builder.AddCustomAttributes(typeof(CreateWorkbook),
                ...
                new DescriptionAttribute("Create Excel File"),
                new ToolboxBitmapAttribute(typeof(CreateWorkbook), @"Icons.Excel_CreateExcelFile.png"));
        }
