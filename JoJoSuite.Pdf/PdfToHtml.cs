...
{
    public partial class PdfToHtml : UserControl
    {
        ...
        private void pnlMain_Click(object sender, EventArgs e)
        {
            ...
            if (ctrls.Length == 1)
            {
                ...
                PdfToHtmlProp p1 = new PdfToHtmlProp();
                p1.pdftoHtml = this;
        ...
        public string GetCodeSnippet()
        {
            ...
            if (File.Exists(sCodeFolder + @"\Pdf\PdfToHtml.txt"))
            {
                using (StreamReader reader = new StreamReader(sCodeFolder + @"\Pdf\PdfToHtml.txt"))
                {
