    ...
    public class r2rReadDataset
    {
        ...
        public async Task<bool> DoAction()
        {
            ...
            try
            {
                ...
                {
                    using (var reader = (Path.GetExtension(_filepath).ToUpper() == ".XLS")?
                        ExcelReaderFactory.CreateReader(stream): ExcelReaderFactory.CreateOpenXmlReader(stream))
                    {
